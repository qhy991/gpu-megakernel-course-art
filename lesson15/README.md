...
# 第 15 课｜完整填写一张 Same-body 实验卡

![第 15 课：完整填写一张 Same-body 实验卡](./lesson-15.png)

> 用同一数学 body 比较 CUDA Graph 与 resident layer，明确变量、计时边界、正确性门和停止条件。

## 零基础先看这里

- **它在解决什么：**怎样设计让别人能复现和质疑的实验？
- **把它想成：**实验卡像完整菜谱，材料、步骤和火候都要写到别人能照做。
- **这次先不用懂：**可先忽略模板样式和自动生成报告。

## 本课结论与证据状态

- **一句话结论：**实验卡应让第三个人能够复跑并推翻你的解释。
- **证据状态：**EXPERIMENT CARD · PROPOSED
...
1. 先不看上文，用自己的话回答：怎样设计让别人能复现和质疑的实验？
2. 再对照本课结论：实验卡应让第三个人能够复跑并推翻你的解释。
3. 根据 `EXPERIMENT CARD · PROPOSED`，说出这条结论能证明什么、不能外推什么。

## 继续学习

- [在线阅读本课](https://qhy991.github.io/gpu-megakernel-course-art/lessons/same-body-experiment-card/)
- [← 上一课 · 第 14 课：首周可执行实验清单](../lesson14/)
- [下一课 · 第 16 课：不先相信 RESULT.md：自己复算一次 B200 实验 →](../lesson16/)
