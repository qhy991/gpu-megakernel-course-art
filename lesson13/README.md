...
# 第 13 课｜下一轮 Megakernel 实验路线图

![第 13 课：下一轮 Megakernel 实验路线图](./lesson-13.png)

> 把候选路线排成逐级是非题，并规定何时继续扩大融合、何时停止。

## 零基础先看这里

- **它在解决什么：**下一步做什么实验才能最快排除错路？
- **把它想成：**像医生先做最能区分病因的检查，而不是把所有检查都做一遍。
- **这次先不用懂：**可先忽略穷举所有参数和自动化平台。

## 本课结论与证据状态

- **一句话结论：**路线图的价值是尽早证伪错误方向。
- **证据状态：**EXPERIMENT ROADMAP · PROPOSED
...
1. 先不看上文，用自己的话回答：下一步做什么实验才能最快排除错路？
2. 再对照本课结论：路线图的价值是尽早证伪错误方向。
3. 根据 `EXPERIMENT ROADMAP · PROPOSED`，说出这条结论能证明什么、不能外推什么。

## 继续学习

- [在线阅读本课](https://qhy991.github.io/gpu-megakernel-course-art/lessons/experiment-roadmap/)
- [← 上一课 · 第 12 课：从 NCU 追到 PTX 和 SASS](../lesson12/)
- [下一课 · 第 14 课：首周可执行实验清单 →](../lesson14/)
