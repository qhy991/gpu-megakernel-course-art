...
![第 14 课：首周可执行实验清单](./lesson-14.png)

> 把路线图落成一周内可执行的基线冻结、正确性、计时、profile 和归档任务。

## 零基础先看这里

- **它在解决什么：**第一周怎样得到一个可信的结论？
- **把它想成：**像做小实验，先固定条件、只改一项，再重复测量确认。
- **这次先不用懂：**可先忽略大规模参数搜索和结果美化。

## 本课结论与证据状态

- **一句话结论：**先得到一个可信结论，再追求更多候选。
- **证据状态：**EXECUTION PLAN · PROPOSED
...
1. 先不看上文，用自己的话回答：第一周怎样得到一个可信的结论？
2. 再对照本课结论：先得到一个可信结论，再追求更多候选。
3. 根据 `EXECUTION PLAN · PROPOSED`，说出这条结论能证明什么、不能外推什么。

## 继续学习

- [在线阅读本课](https://qhy991.github.io/gpu-megakernel-course-art/lessons/first-week-checklist/)
- [← 上一课 · 第 13 课：下一轮 Megakernel 实验路线图](../lesson13/)
- [下一课 · 第 15 课：完整填写一张 Same-body 实验卡 →](../lesson15/)
